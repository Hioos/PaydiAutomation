...
public class OrderStatusPage extends PageBase{
    public OrderStatusPage(AppiumDriver appiumDriver) {
        super(appiumDriver);
    }
...
@AndroidFindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup/android.view.ViewGroup")
    MobileElement CloseNotification;
...
public void clickLastestOrder(){
    click(LastestOrder);
}
public String getPrice(){
    String s = getText(Price);
    String d = s.substring(8,s.length()-0);
    return d;
}
public String getDate(){
    String s = getText(Date);
    String d = s.substring(9,s.length()-0);
    return d;
}
